...
import { getDevicePreset } from './lowEndPreset'
...
// Apply low-end device preset before user settings (user settings take priority)
const devicePreset = getDevicePreset()
export const options: AppOptions = proxy({
  ...defaultOptions,
  ...devicePreset, // hardware-detected optimizations
