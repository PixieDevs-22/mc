export const defaultOptions = {
  ...
  gpuPreference: 'low-power' as 'default' | 'high-performance' | 'low-power',
  ...
  inventoryNotes: false as boolean,
  inventoryPlaceholders: false,
  inventoryPlayerModel: false,
  modsSupport: false,
  ...
  renderDebug: 'none' as 'none' | 'advanced' | 'basic',
